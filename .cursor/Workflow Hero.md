...
<link href="[https://db.onlinewebfonts.com/c/6e47ef470dd19698c911332a9b4d1cf4?family=Neue+Haas+Grotesk+Text+Pro](https://db.onlinewebfonts.com/c/6e47ef470dd19698c911332a9b4d1cf4?family=Neue+Haas+Grotesk+Text+Pro)" rel="stylesheet" />

<link href="[https://db.onlinewebfonts.com/c/dec0d9b4e22ca588dc20e1e2e09a59b5?family=Neue+Haas+Grotesk+Display+Pro+55+Roman](https://db.onlinewebfonts.com/c/dec0d9b4e22ca588dc20e1e2e09a59b5?family=Neue+Haas+Grotesk+Display+Pro+55+Roman)" rel="stylesheet" />
...
[https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260511_131941_d136af49-e243-493a-be14-6ff3f24e09e6.mp4](https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260511_131941_d136af49-e243-493a-be14-6ff3f24e09e6.mp4)
...
export default function BoomerangVideoBg({ src, className }: Props) {
  ...
  useEffect(() => {
    ...
    let last = [performance.now](http://performance.now)();
...
function App() {
  ...
  useEffect(() => {
    ...
    if (menuOpen) {
      ...
      [document.body.style](http://document.body.style).overflow = 'hidden';

    } else {

      [document.body.style](http://document.body.style).overflow = '';
    ...
    <section className="relative w-full min-h-screen sm:h-screen overflow-hidden">
      ...
      <nav className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between px-4 sm:px-6 md:px-10 py-4 sm:py-6">
        ...
        <div className="hidden lg:flex items-center gap-1 bg-white/70 backdrop-blur-md rounded-full pl-6 pr-1 py-1 shadow-sm border border-white/60">
          ...
          {[navLinks.map](http://navLinks.map)((link, i) => (
